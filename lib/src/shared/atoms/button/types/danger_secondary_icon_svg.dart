...
class _Auth0BtnDangerSecondaryIconSvg extends Auth0BtnInterface {
  _Auth0BtnDangerSecondaryIconSvg({
...
class Auth0BtnDangerSecondaryIconSvg extends StatelessWidget {
  const Auth0BtnDangerSecondaryIconSvg({
    super.key,
    required this.label,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    return _Auth0BtnGeneric(
      ...
      btnType: _Auth0BtnDangerSecondaryIconSvg(
