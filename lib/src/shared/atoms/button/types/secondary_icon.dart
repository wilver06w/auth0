...
class _Auth0BtnSecondaryIcon extends Auth0BtnInterface {
  _Auth0BtnSecondaryIcon({
...
class Auth0BtnSecondaryIcon extends StatelessWidget {
  const Auth0BtnSecondaryIcon({
    super.key,
    required this.label,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    return _Auth0BtnGeneric(
      ...
      btnType: _Auth0BtnSecondaryIcon(
