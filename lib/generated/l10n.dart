...
class S {
  ...
  /// `Pragma Inicio sesión con Auth0`
  ...
  /// `Si`
  String get yes {
    return Intl.message('Si', name: 'yes', desc: '', args: []);
  }

  /// `No`
  String get not {
    return Intl.message('No', name: 'not', desc: '', args: []);
  }
  ...
  /// `Correo`
  String get email {
    return Intl.message('Correo', name: 'email', desc: '', args: []);
  }
  ...
  String get updatedAt {
    return Intl.message('Actualizada', name: 'updatedAt', desc: '', args: []);
  }
